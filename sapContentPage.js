...
(function () {
    ...
    var C = {
      BasePath:
        "https://s4cloudlpiz4055ed249.cn1.platform.sapcloud.cn/elastic-access/sap/lpi/",
    ...
    var R = {
          ...
          for (var I = 0; I < M && I < p.length; I++) {
            if (R.CSS.hasClass(p[I].widget, "sapCpWidgetMandatory")) {
              ...
              if (R.Node.getFirstWithClassName(p[I].widget, "sapCpDropDown")) {
                Array.from(
                  R.Node.getAllWithClassName(p[I].widget, "sapCpDropDown")
                ).forEach(function (s) {
      ...
      Widget: {
        ...
        addProgressiveEnabledWidgets: function (w) {
          ...
          if (i && !i.value) {
            return { widgetPrio: R.Setting.get(W, "wProgres-prio"), widget: W };
          }
          return null;
        },
          ...
          if (R.Setting.get(i, "wProgres-enabled") === "true") {
            ...
            if (R.CSS.hasClass(i, "sapCpWidgetMandatory")) {
              if (R.Node.getFirstWithClassName(i, "sapCpInput")) {
                R.Node.getFirstWithClassName(i, "sapCpInput").removeAttribute(
                  "required"
                );
              }
              ...
              if (R.Node.getFirstWithClassName(i, "sapCpCheckBox")) {
                R.Node.getFirstWithClassName(i, "sapCpCheckBox").removeAttribute(
                  "required"
                );
              }
            }
